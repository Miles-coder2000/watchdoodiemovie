...
export const Trending = () => {
  ...
  document.title = "WatchDoodie | Trending " + category.toUpperCase();
  ...
  const refershHandler = useCallback(async () => {
  ...
  return trending.length > 0 ? (
    <div className=" w-screen  h-screen  bg-[#303030]">
      ...
      <div className="sm:flex sm:justify-center sm:gap-5 mt-3 mb-3 hidden">
          <Dropdown
            title="Category"
            options={["movie", "tv"]}
            func={(e) => setcategory(e.target.value)}
